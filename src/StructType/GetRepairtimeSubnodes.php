...
/**
 * This class stands for getRepairtimeSubnodes StructType
 * @subpackage Structs
 */
class GetRepairtimeSubnodes extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $nodeId;
    /**
     * Constructor method for getRepairtimeSubnodes
     * @uses GetRepairtimeSubnodes::setVrid()
     * @uses GetRepairtimeSubnodes::setDescriptionLanguage()
     * @uses GetRepairtimeSubnodes::setRepairtimeTypeId()
     * @uses GetRepairtimeSubnodes::setNodeId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeSubnodes
     */
