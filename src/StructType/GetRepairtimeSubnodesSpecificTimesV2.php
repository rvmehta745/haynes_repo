...
/**
 * This class stands for getRepairtimeSubnodesSpecificTimesV2 StructType
 * @subpackage Structs
 */
class GetRepairtimeSubnodesSpecificTimesV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getRepairtimeSubnodesSpecificTimesV2
     * @uses GetRepairtimeSubnodesSpecificTimesV2::setVrid()
     * @uses GetRepairtimeSubnodesSpecificTimesV2::setDescriptionLanguage()
     * @uses GetRepairtimeSubnodesSpecificTimesV2::setRepairtimeTypeId()
     * @uses GetRepairtimeSubnodesSpecificTimesV2::setTypeCategory()
     * @uses GetRepairtimeSubnodesSpecificTimesV2::setNodeId()
     * @uses GetRepairtimeSubnodesSpecificTimesV2::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeSubnodesSpecificTimesV2
     */
