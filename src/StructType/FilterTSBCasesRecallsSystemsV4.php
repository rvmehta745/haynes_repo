...
/**
 * This class stands for filterTSBCasesRecallsSystemsV4 StructType
 * @subpackage Structs
 */
class FilterTSBCasesRecallsSystemsV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $searchedText;
    /**
     * Constructor method for filterTSBCasesRecallsSystemsV4
     * @uses FilterTSBCasesRecallsSystemsV4::setVrid()
     * @uses FilterTSBCasesRecallsSystemsV4::setDescriptionLanguage()
     * @uses FilterTSBCasesRecallsSystemsV4::setCarTypeId()
     * @uses FilterTSBCasesRecallsSystemsV4::setCarTypeGroup()
     * @uses FilterTSBCasesRecallsSystemsV4::setSearchedText()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\FilterTSBCasesRecallsSystemsV4
     */
