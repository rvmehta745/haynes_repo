...
/**
 * This class stands for getDrawingsV4 StructType
 * @subpackage Structs
 */
class GetDrawingsV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getDrawingsV4
     * @uses GetDrawingsV4::setVrid()
     * @uses GetDrawingsV4::setDescriptionLanguage()
     * @uses GetDrawingsV4::setCarTypeId()
     * @uses GetDrawingsV4::setRepairTimesTypeId()
     * @uses GetDrawingsV4::setTypeCategory()
     * @uses GetDrawingsV4::setCarTypeGroup()
     * @uses GetDrawingsV4::setAxleComponents()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetDrawingsV4
     */
    ...
    public static function validateAxleComponentsForArrayConstraintsFromSetAxleComponents(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getDrawingsV4AxleComponentsItem) {
            // validation for constraint: itemType
            if (!(is_int($getDrawingsV4AxleComponentsItem) || ctype_digit($getDrawingsV4AxleComponentsItem))) {
                $invalidValues[] = is_object($getDrawingsV4AxleComponentsItem) ? get_class($getDrawingsV4AxleComponentsItem) : sprintf('%s(%s)', gettype($getDrawingsV4AxleComponentsItem), var_export($getDrawingsV4AxleComponentsItem, true));
            }
        }
