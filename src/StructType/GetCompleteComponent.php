...
/**
 * This class stands for getCompleteComponent StructType
 * @subpackage Structs
 */
class GetCompleteComponent extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getCompleteComponent
     * @uses GetCompleteComponent::setVrid()
     * @uses GetCompleteComponent::setTypeId()
     * @uses GetCompleteComponent::setSi()
     * @uses GetCompleteComponent::setSt()
     * @uses GetCompleteComponent::setLanguage()
     * @param string $vrid
     * @param int $typeId
     * @param int $si
     * @param int $st
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetCompleteComponent
     */
