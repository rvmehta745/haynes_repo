...
/**
 * This class stands for getRepairtimeSubnodesTextSearchV3 StructType
 * @subpackage Structs
 */
class GetRepairtimeSubnodesTextSearchV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getRepairtimeSubnodesTextSearchV3
     * @uses GetRepairtimeSubnodesTextSearchV3::setVrid()
     * @uses GetRepairtimeSubnodesTextSearchV3::setDescriptionLanguage()
     * @uses GetRepairtimeSubnodesTextSearchV3::setRepairtimeTypeId()
     * @uses GetRepairtimeSubnodesTextSearchV3::setTypeCategory()
     * @uses GetRepairtimeSubnodesTextSearchV3::setNodeId()
     * @uses GetRepairtimeSubnodesTextSearchV3::setSearchText()
     * @uses GetRepairtimeSubnodesTextSearchV3::setCarTypeGroup()
     * @param string $vrid
     ...
     */
    public function __construct($vrid = null, $descriptionLanguage = null, $repairtimeTypeId = null, $typeCategory = null, $nodeId = null, $searchText = null, $carTypeGroup = null)
    {
        $this
            ->setVrid($vrid)
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeSubnodesTextSearchV3
     */
