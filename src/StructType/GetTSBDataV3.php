...
/**
 * This class stands for getTSBDataV3 StructType
 * @subpackage Structs
 */
class GetTSBDataV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getTSBDataV3
     * @uses GetTSBDataV3::setVrid()
     * @uses GetTSBDataV3::setDescriptionLanguage()
     * @uses GetTSBDataV3::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetTSBDataV3
     */
