...
/**
 * This class stands for getStoryInfoV4 StructType
 * @subpackage Structs
 */
class GetStoryInfoV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $smartLinks;
    /**
     * Constructor method for getStoryInfoV4
     * @uses GetStoryInfoV4::setVrid()
     * @uses GetStoryInfoV4::setDescriptionLanguage()
     * @uses GetStoryInfoV4::setCarTypeId()
     * @uses GetStoryInfoV4::setStoryId()
     * @uses GetStoryInfoV4::setSmartLinks()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetStoryInfoV4
     */
