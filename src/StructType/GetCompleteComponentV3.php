...
/**
 * This class stands for getCompleteComponentV3 StructType
 * @subpackage Structs
 */
class GetCompleteComponentV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getCompleteComponentV3
     * @uses GetCompleteComponentV3::setVrid()
     * @uses GetCompleteComponentV3::setTypeId()
     * @uses GetCompleteComponentV3::setSi()
     * @uses GetCompleteComponentV3::setSt()
     * @uses GetCompleteComponentV3::setLanguage()
     * @param string $vrid
     * @param int $typeId
     * @param int $si
     * @param int $st
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetCompleteComponentV3
     */
