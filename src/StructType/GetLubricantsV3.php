...
/**
 * This class stands for getLubricantsV3 StructType
 * @subpackage Structs
 */
class GetLubricantsV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getLubricantsV3
     * @uses GetLubricantsV3::setVrid()
     * @uses GetLubricantsV3::setDescriptionLanguage()
     * @uses GetLubricantsV3::setCarType()
     * @uses GetLubricantsV3::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetLubricantsV3
     */
