...
/**
 * This class stands for getMaintenanceTasksV4 StructType
 * @subpackage Structs
 */
class GetMaintenanceTasksV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getMaintenanceTasksV4
     * @uses GetMaintenanceTasksV4::setVrid()
     * @uses GetMaintenanceTasksV4::setDescriptionLanguage()
     * @uses GetMaintenanceTasksV4::setCarTypeId()
     * @uses GetMaintenanceTasksV4::setRepairtimesTypeId()
     * @uses GetMaintenanceTasksV4::setRtTypeCategory()
     * @uses GetMaintenanceTasksV4::setSystemId()
     * @uses GetMaintenanceTasksV4::setPeriodId()
     * @uses GetMaintenanceTasksV4::setIncludeSmartLinks()
     * @uses GetMaintenanceTasksV4::setIncludeServiceTimes()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceTasksV4
     */
    ...
    public static function validatePeriodIdForArrayConstraintsFromSetPeriodId(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getMaintenanceTasksV4PeriodIdItem) {
            // validation for constraint: itemType
            if (!(is_int($getMaintenanceTasksV4PeriodIdItem) || ctype_digit($getMaintenanceTasksV4PeriodIdItem))) {
                $invalidValues[] = is_object($getMaintenanceTasksV4PeriodIdItem) ? get_class($getMaintenanceTasksV4PeriodIdItem) : sprintf('%s(%s)', gettype($getMaintenanceTasksV4PeriodIdItem), var_export($getMaintenanceTasksV4PeriodIdItem, true));
            }
        }
