...
/**
 * This class stands for getRecallData StructType
 * @subpackage Structs
 */
class GetRecallData extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getRecallData
     * @uses GetRecallData::setVrid()
     * @uses GetRecallData::setDescriptionLanguage()
     * @uses GetRecallData::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRecallData
     */
