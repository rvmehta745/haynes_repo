...
/**
 * This class stands for getRepairtimeNodesByGenartsV2 StructType
 * @subpackage Structs
 */
class GetRepairtimeNodesByGenartsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getRepairtimeNodesByGenartsV2
     * @uses GetRepairtimeNodesByGenartsV2::setVrid()
     * @uses GetRepairtimeNodesByGenartsV2::setDescriptionLanguage()
     * @uses GetRepairtimeNodesByGenartsV2::setRepairtimeTypeId()
     * @uses GetRepairtimeNodesByGenartsV2::setTypeCategory()
     * @uses GetRepairtimeNodesByGenartsV2::setGenArtNumbers()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeNodesByGenartsV2
     */
    ...
    public static function validateGenArtNumbersForArrayConstraintsFromSetGenArtNumbers(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getRepairtimeNodesByGenartsV2GenArtNumbersItem) {
            // validation for constraint: itemType
            if (!(is_int($getRepairtimeNodesByGenartsV2GenArtNumbersItem) || ctype_digit($getRepairtimeNodesByGenartsV2GenArtNumbersItem))) {
                $invalidValues[] = is_object($getRepairtimeNodesByGenartsV2GenArtNumbersItem) ? get_class($getRepairtimeNodesByGenartsV2GenArtNumbersItem) : sprintf('%s(%s)', gettype($getRepairtimeNodesByGenartsV2GenArtNumbersItem), var_export($getRepairtimeNodesByGenartsV2GenArtNumbersItem, true));
            }
        }
