...
/**
 * This class stands for getCompleteComponentV4 StructType
 * @subpackage Structs
 */
class GetCompleteComponentV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getCompleteComponentV4
     * @uses GetCompleteComponentV4::setVrid()
     * @uses GetCompleteComponentV4::setTypeId()
     * @uses GetCompleteComponentV4::setSi()
     * @uses GetCompleteComponentV4::setSt()
     * @uses GetCompleteComponentV4::setLanguage()
     * @param string $vrid
     * @param int $typeId
     * @param int $si
     * @param int $st
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetCompleteComponentV4
     */
