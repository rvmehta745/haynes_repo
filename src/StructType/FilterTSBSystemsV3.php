...
/**
 * This class stands for filterTSBSystemsV3 StructType
 * @subpackage Structs
 */
class FilterTSBSystemsV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $searchedText;
    /**
     * Constructor method for filterTSBSystemsV3
     * @uses FilterTSBSystemsV3::setVrid()
     * @uses FilterTSBSystemsV3::setDescriptionLanguage()
     * @uses FilterTSBSystemsV3::setCarTypeId()
     * @uses FilterTSBSystemsV3::setCarTypeGroup()
     * @uses FilterTSBSystemsV3::setSearchedText()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\FilterTSBSystemsV3
     */
