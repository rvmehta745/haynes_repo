...
/**
 * This class stands for getTSBSystemsV2 StructType
 * @subpackage Structs
 */
class GetTSBSystemsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getTSBSystemsV2
     * @uses GetTSBSystemsV2::setVrid()
     * @uses GetTSBSystemsV2::setDescriptionLanguage()
     * @uses GetTSBSystemsV2::setCarTypeId()
     * @uses GetTSBSystemsV2::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetTSBSystemsV2
     */
