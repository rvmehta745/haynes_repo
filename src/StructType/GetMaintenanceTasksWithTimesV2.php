...
/**
 * This class stands for getMaintenanceTasksWithTimesV2 StructType
 * @subpackage Structs
 */
class GetMaintenanceTasksWithTimesV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $periodId;
    /**
     * Constructor method for getMaintenanceTasksWithTimesV2
     * @uses GetMaintenanceTasksWithTimesV2::setVrid()
     * @uses GetMaintenanceTasksWithTimesV2::setDescriptionLanguage()
     * @uses GetMaintenanceTasksWithTimesV2::setCarTypeId()
     * @uses GetMaintenanceTasksWithTimesV2::setRepairtimesTypeId()
     * @uses GetMaintenanceTasksWithTimesV2::setSystemId()
     * @uses GetMaintenanceTasksWithTimesV2::setPeriodId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceTasksWithTimesV2
     */
