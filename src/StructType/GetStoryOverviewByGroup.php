...
/**
 * This class stands for getStoryOverviewByGroup StructType
 * @subpackage Structs
 */
class GetStoryOverviewByGroup extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getStoryOverviewByGroup
     * @uses GetStoryOverviewByGroup::setVrid()
     * @uses GetStoryOverviewByGroup::setDescriptionLanguage()
     * @uses GetStoryOverviewByGroup::setCarType()
     * @uses GetStoryOverviewByGroup::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetStoryOverviewByGroup
     */
