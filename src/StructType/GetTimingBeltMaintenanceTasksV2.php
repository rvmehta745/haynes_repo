...
/**
 * This class stands for getTimingBeltMaintenanceTasksV2 StructType
 * @subpackage Structs
 */
class GetTimingBeltMaintenanceTasksV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getTimingBeltMaintenanceTasksV2
     * @uses GetTimingBeltMaintenanceTasksV2::setVrid()
     * @uses GetTimingBeltMaintenanceTasksV2::setDescriptionLanguage()
     * @uses GetTimingBeltMaintenanceTasksV2::setRepairtimesTypeId()
     * @uses GetTimingBeltMaintenanceTasksV2::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetTimingBeltMaintenanceTasksV2
     */
