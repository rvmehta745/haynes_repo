...
/**
 * This class stands for FaultCode3 StructType
 * @subpackage Structs
 */
class FaultCode3 extends AbstractStructBase
{
    /**
     * The ct_text
    ...
    public $id;
    /**
     * Constructor method for FaultCode3
     * @uses FaultCode3::setCt_text()
     * @uses FaultCode3::setDiagnosticComponents()
     * @uses FaultCode3::setFc_code()
     * @uses FaultCode3::setFc_code2()
     * @uses FaultCode3::setFd_component_name_id()
     * @uses FaultCode3::setFd_id()
     * @uses FaultCode3::setFd_plausible()
     * @uses FaultCode3::setFd_si_number()
     * @uses FaultCode3::setFt_text()
     * @uses FaultCode3::setId()
     ...
     * @param int $id
     */
    public function __construct($ct_text = null, \ArrayType\ArrayOf_tns2_DiagnosticComponentV2 $diagnosticComponents = null, $fc_code = null, $fc_code2 = null, $fd_component_name_id = null, $fd_id = null, $fd_plausible = null, $fd_si_number = null, $ft_text = null, $id = null)
    {
        $this
            ->setCt_text($ct_text)
