...
/**
 * This class stands for getManagementFaultCode StructType
 * @subpackage Structs
 */
class GetManagementFaultCode extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $managementId;
    /**
     * Constructor method for getManagementFaultCode
     * @uses GetManagementFaultCode::setVrid()
     * @uses GetManagementFaultCode::setDescriptionLanguage()
     * @uses GetManagementFaultCode::setCarTypeId()
     * @uses GetManagementFaultCode::setManagementId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetManagementFaultCode
     */
