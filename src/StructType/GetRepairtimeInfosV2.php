...
/**
 * This class stands for getRepairtimeInfosV2 StructType
 * @subpackage Structs
 */
class GetRepairtimeInfosV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $nodeId;
    /**
     * Constructor method for getRepairtimeInfosV2
     * @uses GetRepairtimeInfosV2::setVrid()
     * @uses GetRepairtimeInfosV2::setDescriptionLanguage()
     * @uses GetRepairtimeInfosV2::setRepairtimeTypeId()
     * @uses GetRepairtimeInfosV2::setTypeCategory()
     * @uses GetRepairtimeInfosV2::setNodeId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeInfosV2
     */
