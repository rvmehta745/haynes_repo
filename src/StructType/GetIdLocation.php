...
/**
 * This class stands for getIdLocation StructType
 * @subpackage Structs
 */
class GetIdLocation extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeLevel;
    /**
     * Constructor method for getIdLocation
     * @uses GetIdLocation::setVrid()
     * @uses GetIdLocation::setDescriptionLanguage()
     * @uses GetIdLocation::setCarTypeId()
     * @uses GetIdLocation::setCarTypeLevel()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetIdLocation
     */
