...
/**
 * This class stands for getSchemaLocations2 StructType
 * @subpackage Structs
 */
class GetSchemaLocations2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $managementId;
    /**
     * Constructor method for getSchemaLocations2
     * @uses GetSchemaLocations2::setVrid()
     * @uses GetSchemaLocations2::setDescriptionLanguage()
     * @uses GetSchemaLocations2::setCarTypeId()
     * @uses GetSchemaLocations2::setManagementId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetSchemaLocations2
     */
