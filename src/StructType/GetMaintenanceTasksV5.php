...
/**
 * This class stands for getMaintenanceTasksV5 StructType
 * @subpackage Structs
 */
class GetMaintenanceTasksV5 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getMaintenanceTasksV5
     * @uses GetMaintenanceTasksV5::setVrid()
     * @uses GetMaintenanceTasksV5::setDescriptionLanguage()
     * @uses GetMaintenanceTasksV5::setCarTypeId()
     * @uses GetMaintenanceTasksV5::setRepairtimesTypeId()
     * @uses GetMaintenanceTasksV5::setRtTypeCategory()
     * @uses GetMaintenanceTasksV5::setSystemId()
     * @uses GetMaintenanceTasksV5::setPeriodId()
     * @uses GetMaintenanceTasksV5::setIncludeSmartLinks()
     * @uses GetMaintenanceTasksV5::setIncludeServiceTimes()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceTasksV5
     */
    ...
    public static function validatePeriodIdForArrayConstraintsFromSetPeriodId(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getMaintenanceTasksV5PeriodIdItem) {
            // validation for constraint: itemType
            if (!(is_int($getMaintenanceTasksV5PeriodIdItem) || ctype_digit($getMaintenanceTasksV5PeriodIdItem))) {
                $invalidValues[] = is_object($getMaintenanceTasksV5PeriodIdItem) ? get_class($getMaintenanceTasksV5PeriodIdItem) : sprintf('%s(%s)', gettype($getMaintenanceTasksV5PeriodIdItem), var_export($getMaintenanceTasksV5PeriodIdItem, true));
            }
        }
