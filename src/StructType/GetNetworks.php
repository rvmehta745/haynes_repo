...
/**
 * This class stands for getNetworks StructType
 * @subpackage Structs
 */
class GetNetworks extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getNetworks
     * @uses GetNetworks::setVrid()
     * @uses GetNetworks::setSystem_types_ids()
     * @uses GetNetworks::setSystem_types_groups()
     * @uses GetNetworks::setCar_type()
     * @uses GetNetworks::setLanguage()
     * @param string $vrid
    ...
    public static function validateSystem_types_idsForArrayConstraintsFromSetSystem_types_ids(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getNetworksSystem_types_idsItem) {
            // validation for constraint: itemType
            if (!(is_int($getNetworksSystem_types_idsItem) || ctype_digit($getNetworksSystem_types_idsItem))) {
                $invalidValues[] = is_object($getNetworksSystem_types_idsItem) ? get_class($getNetworksSystem_types_idsItem) : sprintf('%s(%s)', gettype($getNetworksSystem_types_idsItem), var_export($getNetworksSystem_types_idsItem, true));
            }
        }
    ...
    public static function validateSystem_types_groupsForArrayConstraintsFromSetSystem_types_groups(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getNetworksSystem_types_groupsItem) {
            // validation for constraint: itemType
            if (!(is_int($getNetworksSystem_types_groupsItem) || ctype_digit($getNetworksSystem_types_groupsItem))) {
                $invalidValues[] = is_object($getNetworksSystem_types_groupsItem) ? get_class($getNetworksSystem_types_groupsItem) : sprintf('%s(%s)', gettype($getNetworksSystem_types_groupsItem), var_export($getNetworksSystem_types_groupsItem, true));
            }
        }
        if (!empty($invalidValues)) {
