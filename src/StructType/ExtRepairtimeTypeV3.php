...
/**
 * This class stands for ExtRepairtimeTypeV3 StructType
 * @subpackage Structs
 */
class ExtRepairtimeTypeV3 extends AbstractStructBase
{
    /**
     * The madeFrom
    ...
    public $typeCategory;
    /**
     * Constructor method for ExtRepairtimeTypeV3
     * @uses ExtRepairtimeTypeV3::setMadeFrom()
     * @uses ExtRepairtimeTypeV3::setMadeUntil()
     * @uses ExtRepairtimeTypeV3::setMake()
     * @uses ExtRepairtimeTypeV3::setModel()
     * @uses ExtRepairtimeTypeV3::setMotnrs()
     * @uses ExtRepairtimeTypeV3::setOutput()
     * @uses ExtRepairtimeTypeV3::setRepairtimeTypeId()
     * @uses ExtRepairtimeTypeV3::setRootNodeId()
     * @uses ExtRepairtimeTypeV3::setStatus()
     * @uses ExtRepairtimeTypeV3::setType()
     * @uses ExtRepairtimeTypeV3::setTypeCategory()
     * @param string $madeFrom
     * @param string $madeUntil
     * @param string $make
     * @param string $model
     * @param \ArrayType\ArrayOf_xsd_int $motnrs
     * @param int $output
     ...
     */
    public function __construct($madeFrom = null, $madeUntil = null, $make = null, $model = null, \ArrayType\ArrayOf_xsd_int $motnrs = null, $output = null, $repairtimeTypeId = null, $rootNodeId = null, \StructType\ExtStatus $status = null, $type = null, $typeCategory = null)
    {
        $this
     ...
     * Set madeFrom value
     * @param string $madeFrom
     * @return \StructType\ExtRepairtimeTypeV3
     */
     ...
     * @return \StructType\ExtRepairtimeTypeV3
     */
    public function setMotnrs(\ArrayType\ArrayOf_xsd_int $motnrs = null)
    {
        $this->motnrs = $motnrs;
        return $this;
    }
