...
/**
 * This class stands for getLubricantCapacitiesV3 StructType
 * @subpackage Structs
 */
class GetLubricantCapacitiesV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getLubricantCapacitiesV3
     * @uses GetLubricantCapacitiesV3::setVrid()
     * @uses GetLubricantCapacitiesV3::setDescriptionLanguage()
     * @uses GetLubricantCapacitiesV3::setCarType()
     * @uses GetLubricantCapacitiesV3::setCarTypeGroup()
     * @uses GetLubricantCapacitiesV3::setIncludeSmartLinks()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetLubricantCapacitiesV3
     */
