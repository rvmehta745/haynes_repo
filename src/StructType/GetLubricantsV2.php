...
/**
 * This class stands for getLubricantsV2 StructType
 * @subpackage Structs
 */
class GetLubricantsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getLubricantsV2
     * @uses GetLubricantsV2::setVrid()
     * @uses GetLubricantsV2::setDescriptionLanguage()
     * @uses GetLubricantsV2::setCarType()
     * @uses GetLubricantsV2::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetLubricantsV2
     */
