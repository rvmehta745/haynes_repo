...
/**
 * This class stands for getRepairtimeSubnodesByGroupV2 StructType
 * @subpackage Structs
 */
class GetRepairtimeSubnodesByGroupV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getRepairtimeSubnodesByGroupV2
     * @uses GetRepairtimeSubnodesByGroupV2::setVrid()
     * @uses GetRepairtimeSubnodesByGroupV2::setDescriptionLanguage()
     * @uses GetRepairtimeSubnodesByGroupV2::setRepairtimeTypeId()
     * @uses GetRepairtimeSubnodesByGroupV2::setTypeCategory()
     * @uses GetRepairtimeSubnodesByGroupV2::setNodeId()
     * @uses GetRepairtimeSubnodesByGroupV2::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeSubnodesByGroupV2
     */
