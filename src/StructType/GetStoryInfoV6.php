...
/**
 * This class stands for getStoryInfoV6 StructType
 * @subpackage Structs
 */
class GetStoryInfoV6 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $smartLinks;
    /**
     * Constructor method for getStoryInfoV6
     * @uses GetStoryInfoV6::setVrid()
     * @uses GetStoryInfoV6::setDescriptionLanguage()
     * @uses GetStoryInfoV6::setCarTypeId()
     * @uses GetStoryInfoV6::setStoryId()
     * @uses GetStoryInfoV6::setSmartLinks()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetStoryInfoV6
     */
