...
/**
 * This class stands for getTSBCasesRecallsSystemsV4 StructType
 * @subpackage Structs
 */
class GetTSBCasesRecallsSystemsV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getTSBCasesRecallsSystemsV4
     * @uses GetTSBCasesRecallsSystemsV4::setVrid()
     * @uses GetTSBCasesRecallsSystemsV4::setDescriptionLanguage()
     * @uses GetTSBCasesRecallsSystemsV4::setCarTypeId()
     * @uses GetTSBCasesRecallsSystemsV4::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetTSBCasesRecallsSystemsV4
     */
