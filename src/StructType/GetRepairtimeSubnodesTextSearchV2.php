...
/**
 * This class stands for getRepairtimeSubnodesTextSearchV2 StructType
 * @subpackage Structs
 */
class GetRepairtimeSubnodesTextSearchV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getRepairtimeSubnodesTextSearchV2
     * @uses GetRepairtimeSubnodesTextSearchV2::setVrid()
     * @uses GetRepairtimeSubnodesTextSearchV2::setDescriptionLanguage()
     * @uses GetRepairtimeSubnodesTextSearchV2::setRepairtimeTypeId()
     * @uses GetRepairtimeSubnodesTextSearchV2::setTypeCategory()
     * @uses GetRepairtimeSubnodesTextSearchV2::setNodeId()
     * @uses GetRepairtimeSubnodesTextSearchV2::setSearchText()
     * @uses GetRepairtimeSubnodesTextSearchV2::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeSubnodesTextSearchV2
     */
