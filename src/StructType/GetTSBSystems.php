...
/**
 * This class stands for getTSBSystems StructType
 * @subpackage Structs
 */
class GetTSBSystems extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getTSBSystems
     * @uses GetTSBSystems::setVrid()
     * @uses GetTSBSystems::setDescriptionLanguage()
     * @uses GetTSBSystems::setCarTypeId()
     * @uses GetTSBSystems::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetTSBSystems
     */
