...
/**
 * This class stands for CompleteComponentV2 StructType
 * @subpackage Structs
 */
class CompleteComponentV2 extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - nillable: true
     * @var \ArrayType\ArrayOf_tns2_WizardV2
     */
    ...
    public $renderable;
    /**
     * Constructor method for CompleteComponentV2
     * @uses CompleteComponentV2::setComponentImageId()
     * @uses CompleteComponentV2::setConnectorSideImage()
     * @uses CompleteComponentV2::setDiagnosisSteps()
     * @uses CompleteComponentV2::setEcuSideImage()
     * @uses CompleteComponentV2::setGenericParts()
     * @uses CompleteComponentV2::setHasLocationSystems()
     * @uses CompleteComponentV2::setLocalWiringImage()
     * @uses CompleteComponentV2::setPinTable()
     * @uses CompleteComponentV2::setRenderable()
     * @param int $componentImageId
     * @param string $connectorSideImage
     * @param \ArrayType\ArrayOf_tns2_WizardV2 $diagnosisSteps
     ...
     */
    public function __construct($componentImageId = null, $connectorSideImage = null, \ArrayType\ArrayOf_tns2_WizardV2 $diagnosisSteps = null, $ecuSideImage = null, \ArrayType\ArrayOf_tns2_GenericPart $genericParts = null, $hasLocationSystems = null, $localWiringImage = null, \ArrayType\PinsArray $pinTable = null, $renderable = null)
    {
        $this
     ...
     * @param int $componentImageId
     * @return \StructType\CompleteComponentV2
     */
     ...
     * @return \ArrayType\ArrayOf_tns2_WizardV2|null
     */
     ...
     * @return \StructType\CompleteComponentV2
     */
    public function setDiagnosisSteps(\ArrayType\ArrayOf_tns2_WizardV2 $diagnosisSteps = null)
    {
