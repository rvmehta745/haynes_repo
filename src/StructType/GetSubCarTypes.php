...
/**
 * This class stands for getSubCarTypes StructType
 * @subpackage Structs
 */
class GetSubCarTypes extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeLevel;
    /**
     * Constructor method for getSubCarTypes
     * @uses GetSubCarTypes::setVrid()
     * @uses GetSubCarTypes::setDescriptionLanguage()
     * @uses GetSubCarTypes::setCarTypeId()
     * @uses GetSubCarTypes::setCarTypeLevel()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetSubCarTypes
     */
