...
/**
 * This class stands for getMaintenanceSystemOverview StructType
 * @subpackage Structs
 */
class GetMaintenanceSystemOverview extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getMaintenanceSystemOverview
     * @uses GetMaintenanceSystemOverview::setVrid()
     * @uses GetMaintenanceSystemOverview::setDescriptionLanguage()
     * @uses GetMaintenanceSystemOverview::setCarTypeId()
     * @uses GetMaintenanceSystemOverview::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceSystemOverview
     */
