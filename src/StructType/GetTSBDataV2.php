...
/**
 * This class stands for getTSBDataV2 StructType
 * @subpackage Structs
 */
class GetTSBDataV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getTSBDataV2
     * @uses GetTSBDataV2::setVrid()
     * @uses GetTSBDataV2::setDescriptionLanguage()
     * @uses GetTSBDataV2::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetTSBDataV2
     */
