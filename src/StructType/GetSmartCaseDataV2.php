...
/**
 * This class stands for getSmartCaseDataV2 StructType
 * @subpackage Structs
 */
class GetSmartCaseDataV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getSmartCaseDataV2
     * @uses GetSmartCaseDataV2::setVrid()
     * @uses GetSmartCaseDataV2::setDescriptionLanguage()
     * @uses GetSmartCaseDataV2::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetSmartCaseDataV2
     */
