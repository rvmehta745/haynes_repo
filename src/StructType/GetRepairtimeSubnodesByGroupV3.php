...
/**
 * This class stands for getRepairtimeSubnodesByGroupV3 StructType
 * @subpackage Structs
 */
class GetRepairtimeSubnodesByGroupV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getRepairtimeSubnodesByGroupV3
     * @uses GetRepairtimeSubnodesByGroupV3::setVrid()
     * @uses GetRepairtimeSubnodesByGroupV3::setDescriptionLanguage()
     * @uses GetRepairtimeSubnodesByGroupV3::setRepairtimeTypeId()
     * @uses GetRepairtimeSubnodesByGroupV3::setTypeCategory()
     * @uses GetRepairtimeSubnodesByGroupV3::setNodeId()
     * @uses GetRepairtimeSubnodesByGroupV3::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRepairtimeSubnodesByGroupV3
     */
