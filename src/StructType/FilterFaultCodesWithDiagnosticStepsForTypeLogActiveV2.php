...
/**
 * This class stands for filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2
 * StructType
 * @subpackage Structs
 */
class FilterFaultCodesWithDiagnosticStepsForTypeLogActiveV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActiveV2::setVrid()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActiveV2::setTypeId()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActiveV2::setSystemTypeIds()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActiveV2::setCodesin()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActiveV2::setLanguage()
     * @param string $vrid
     * @param int $typeId
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\FilterFaultCodesWithDiagnosticStepsForTypeLogActiveV2
     */
    ...
    public static function validateCodesinForArrayConstraintsFromSetCodesin(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2CodesinItem) {
            // validation for constraint: itemType
            if (!is_string($filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2CodesinItem)) {
                $invalidValues[] = is_object($filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2CodesinItem) ? get_class($filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2CodesinItem) : sprintf('%s(%s)', gettype($filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2CodesinItem), var_export($filterFaultCodesWithDiagnosticStepsForTypeLogActiveV2CodesinItem, true));
            }
        }
