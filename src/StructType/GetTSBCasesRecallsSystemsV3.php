...
/**
 * This class stands for getTSBCasesRecallsSystemsV3 StructType
 * @subpackage Structs
 */
class GetTSBCasesRecallsSystemsV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getTSBCasesRecallsSystemsV3
     * @uses GetTSBCasesRecallsSystemsV3::setVrid()
     * @uses GetTSBCasesRecallsSystemsV3::setDescriptionLanguage()
     * @uses GetTSBCasesRecallsSystemsV3::setCarTypeId()
     * @uses GetTSBCasesRecallsSystemsV3::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetTSBCasesRecallsSystemsV3
     */
