...
/**
 * This class stands for ExtMaintenanceTaskV4 StructType
 * @subpackage Structs
 */
class ExtMaintenanceTaskV4 extends AbstractStructBase
{
    /**
     * The criteria
     ...
     * Meta information extracted from the WSDL
     * - nillable: true
     * @var \ArrayType\ArrayOfExtMaintenanceTaskV4
     */
    public $subTasks;
    /**
     * The times
    ...
    public $times;
    /**
     * Constructor method for ExtMaintenanceTaskV4
     * @uses ExtMaintenanceTaskV4::setCriteria()
     * @uses ExtMaintenanceTaskV4::setFollowUpRepairs()
     * @uses ExtMaintenanceTaskV4::setGeneralArticles()
     * @uses ExtMaintenanceTaskV4::setLongDescriptions()
     * @uses ExtMaintenanceTaskV4::setMandatoryReplacement()
     * @uses ExtMaintenanceTaskV4::setName()
     * @uses ExtMaintenanceTaskV4::setOrder()
     * @uses ExtMaintenanceTaskV4::setRemark()
     * @uses ExtMaintenanceTaskV4::setRepairTimesTaskId()
     * @uses ExtMaintenanceTaskV4::setSmartLinks()
     * @uses ExtMaintenanceTaskV4::setStatus()
     * @uses ExtMaintenanceTaskV4::setSubTasks()
     * @uses ExtMaintenanceTaskV4::setTimes()
     ...
     * @param \ArrayType\ArrayOfExtMaintenanceTaskV4 $subTasks
     * @param \ArrayType\ArrayOfExtTime $times
     */
    public function __construct(\ArrayType\ArrayOfExtCriteria $criteria = null, \ArrayType\ArrayOfExtRepairtimeNodeV2 $followUpRepairs = null, \ArrayType\ArrayOfExtGeneralArticle $generalArticles = null, \ArrayType\ArrayOf_xsd_string $longDescriptions = null, $mandatoryReplacement = null, $name = null, $order = null, $remark = null, $repairTimesTaskId = null, \ArrayType\ArrayOfExtSmartLink $smartLinks = null, \StructType\ExtStatus $status = null, \ArrayType\ArrayOfExtMaintenanceTaskV4 $subTasks = null, \ArrayType\ArrayOfExtTime $times = null)
    {
        $this
     ...
     * Set criteria value
     * @param \ArrayType\ArrayOfExtCriteria $criteria
     * @return \StructType\ExtMaintenanceTaskV4
     */
    ...
    /**
     * Get subTasks value
     * @return \ArrayType\ArrayOfExtMaintenanceTaskV4|null
     */
     ...
     * @return \StructType\ExtMaintenanceTaskV4
     */
    public function setSubTasks(\ArrayType\ArrayOfExtMaintenanceTaskV4 $subTasks = null)
    {
