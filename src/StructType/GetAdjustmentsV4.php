...
/**
 * This class stands for getAdjustmentsV4 StructType
 * @subpackage Structs
 */
class GetAdjustmentsV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getAdjustmentsV4
     * @uses GetAdjustmentsV4::setVrid()
     * @uses GetAdjustmentsV4::setDescriptionLanguage()
     * @uses GetAdjustmentsV4::setCarType()
     * @uses GetAdjustmentsV4::setCarTypeGroup()
     * @uses GetAdjustmentsV4::setIncludeSmartLinks()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetAdjustmentsV4
     */
