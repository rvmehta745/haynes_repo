...
/**
 * This class stands for getLubricantsArticlesV2 StructType
 * @subpackage Structs
 */
class GetLubricantsArticlesV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getLubricantsArticlesV2
     * @uses GetLubricantsArticlesV2::setVrid()
     * @uses GetLubricantsArticlesV2::setDescriptionLanguage()
     * @uses GetLubricantsArticlesV2::setCarType()
     * @uses GetLubricantsArticlesV2::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetLubricantsArticlesV2
     */
