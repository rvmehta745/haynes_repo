...
/**
 * This class stands for getMaintenanceTasksLocationBasedV6 StructType
 * @subpackage Structs
 */
class GetMaintenanceTasksLocationBasedV6 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getMaintenanceTasksLocationBasedV6
     * @uses GetMaintenanceTasksLocationBasedV6::setVrid()
     * @uses GetMaintenanceTasksLocationBasedV6::setDescriptionLanguage()
     * @uses GetMaintenanceTasksLocationBasedV6::setCarTypeId()
     * @uses GetMaintenanceTasksLocationBasedV6::setRepairtimesTypeId()
     * @uses GetMaintenanceTasksLocationBasedV6::setRtTypeCategory()
     * @uses GetMaintenanceTasksLocationBasedV6::setSystemId()
     * @uses GetMaintenanceTasksLocationBasedV6::setPeriodId()
     * @uses GetMaintenanceTasksLocationBasedV6::setIncludeSmartLinks()
     * @uses GetMaintenanceTasksLocationBasedV6::setIncludeServiceTimes()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceTasksLocationBasedV6
     */
    ...
    public static function validatePeriodIdForArrayConstraintsFromSetPeriodId(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getMaintenanceTasksLocationBasedV6PeriodIdItem) {
            // validation for constraint: itemType
            if (!(is_int($getMaintenanceTasksLocationBasedV6PeriodIdItem) || ctype_digit($getMaintenanceTasksLocationBasedV6PeriodIdItem))) {
                $invalidValues[] = is_object($getMaintenanceTasksLocationBasedV6PeriodIdItem) ? get_class($getMaintenanceTasksLocationBasedV6PeriodIdItem) : sprintf('%s(%s)', gettype($getMaintenanceTasksLocationBasedV6PeriodIdItem), var_export($getMaintenanceTasksLocationBasedV6PeriodIdItem, true));
            }
        }
