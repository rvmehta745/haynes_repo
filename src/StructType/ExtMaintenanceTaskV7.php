...
/**
 * This class stands for ExtMaintenanceTaskV7 StructType
 * @subpackage Structs
 */
class ExtMaintenanceTaskV7 extends AbstractStructBase
{
    /**
     * The criteria
    ...
    public $times;
    /**
     * Constructor method for ExtMaintenanceTaskV7
     * @uses ExtMaintenanceTaskV7::setCriteria()
     * @uses ExtMaintenanceTaskV7::setDescriptionId()
     * @uses ExtMaintenanceTaskV7::setFollowUpRepairs()
     * @uses ExtMaintenanceTaskV7::setGeneralArticles()
     * @uses ExtMaintenanceTaskV7::setGeneralCriterias()
     * @uses ExtMaintenanceTaskV7::setIncludeByDefault()
     * @uses ExtMaintenanceTaskV7::setLongDescriptions()
     * @uses ExtMaintenanceTaskV7::setMandatoryReplacement()
     * @uses ExtMaintenanceTaskV7::setName()
     * @uses ExtMaintenanceTaskV7::setOrder()
     * @uses ExtMaintenanceTaskV7::setOverrulingRemark()
     * @uses ExtMaintenanceTaskV7::setRemark()
     * @uses ExtMaintenanceTaskV7::setRepairTimesTaskId()
     * @uses ExtMaintenanceTaskV7::setSmartLinks()
     * @uses ExtMaintenanceTaskV7::setStatus()
     * @uses ExtMaintenanceTaskV7::setSubTasks()
     * @uses ExtMaintenanceTaskV7::setTimes()
     ...
     * @param \ArrayType\ArrayOfExtMaintenanceTaskV7 $subTasks
     * @param \ArrayType\ArrayOfExtTime $times
     */
    public function __construct(\ArrayType\ArrayOfExtCriteria $criteria = null, $descriptionId = null, \ArrayType\ArrayOfExtRepairtimeNodeV2 $followUpRepairs = null, \ArrayType\ArrayOfExtGeneralArticle $generalArticles = null, \ArrayType\ArrayOfExtCriteriaGroup $generalCriterias = null, $includeByDefault = null, \ArrayType\ArrayOf_xsd_string $longDescriptions = null, $mandatoryReplacement = null, $name = null, $order = null, $overrulingRemark = null, $remark = null, $repairTimesTaskId = null, \ArrayType\ArrayOfExtSmartLink $smartLinks = null, \StructType\ExtStatus $status = null, \ArrayType\ArrayOfExtMaintenanceTaskV7 $subTasks = null, \ArrayType\ArrayOfExtTime $times = null)
    {
        $this
     ...
     * Set criteria value
     * @param \ArrayType\ArrayOfExtCriteria $criteria
     * @return \StructType\ExtMaintenanceTaskV7
     */
     ...
     * @return \StructType\ExtMaintenanceTaskV7
     */
    public function setSubTasks(\ArrayType\ArrayOfExtMaintenanceTaskV7 $subTasks = null)
    {
