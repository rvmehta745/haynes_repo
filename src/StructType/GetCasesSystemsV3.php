...
/**
 * This class stands for getCasesSystemsV3 StructType
 * @subpackage Structs
 */
class GetCasesSystemsV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carTypeGroup;
    /**
     * Constructor method for getCasesSystemsV3
     * @uses GetCasesSystemsV3::setVrid()
     * @uses GetCasesSystemsV3::setDescriptionLanguage()
     * @uses GetCasesSystemsV3::setCarTypeId()
     * @uses GetCasesSystemsV3::setCarTypeGroup()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetCasesSystemsV3
     */
