...
/**
 * This class stands for getTSBData StructType
 * @subpackage Structs
 */
class GetTSBData extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getTSBData
     * @uses GetTSBData::setVrid()
     * @uses GetTSBData::setDescriptionLanguage()
     * @uses GetTSBData::setSystemId()
     * @param string $vrid
