...
/**
 * This class stands for getMaintenanceTasksWithSmartLinksAndTimes StructType
 * @subpackage Structs
 */
class GetMaintenanceTasksWithSmartLinksAndTimes extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $periodId;
    /**
     * Constructor method for getMaintenanceTasksWithSmartLinksAndTimes
     * @uses GetMaintenanceTasksWithSmartLinksAndTimes::setVrid()
     * @uses GetMaintenanceTasksWithSmartLinksAndTimes::setDescriptionLanguage()
     * @uses GetMaintenanceTasksWithSmartLinksAndTimes::setCarTypeId()
     * @uses GetMaintenanceTasksWithSmartLinksAndTimes::setSystemId()
     * @uses GetMaintenanceTasksWithSmartLinksAndTimes::setPeriodId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceTasksWithSmartLinksAndTimes
     */
