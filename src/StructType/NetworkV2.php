...
/**
 * This class stands for NetworkV2 StructType
 * @subpackage Structs
 */
class NetworkV2 extends AbstractStructBase
{
    /**
     * The groupName
     ...
     * Meta information extracted from the WSDL
     * - nillable: true
     * @var \ArrayType\ArrayOf_tns2_NetworkSignalV2
     */
    public $signals_in;
    /**
     * The signals_out
    ...
    public $text;
    /**
     * Constructor method for NetworkV2
     * @uses NetworkV2::setGroupName()
     * @uses NetworkV2::setSgNumber()
     * @uses NetworkV2::setSignals_in()
     * @uses NetworkV2::setSignals_out()
     * @uses NetworkV2::setSystemGroupId()
     * @uses NetworkV2::setSystemTypeId()
     * @uses NetworkV2::setText()
     * @param \ArrayType\ArrayOf_xsd_string $groupName
     * @param int $sgNumber
     * @param \ArrayType\ArrayOf_tns2_NetworkSignalV2 $signals_in
     * @param \ArrayType\ArrayOf_tns2_NetworkSignalV2 $signals_out
     * @param \ArrayType\ArrayOf_xsd_int $systemGroupId
     * @param int $systemTypeId
     * @param string $text
     */
    public function __construct(\ArrayType\ArrayOf_xsd_string $groupName = null, $sgNumber = null, \ArrayType\ArrayOf_tns2_NetworkSignalV2 $signals_in = null, \ArrayType\ArrayOf_tns2_NetworkSignalV2 $signals_out = null, \ArrayType\ArrayOf_xsd_int $systemGroupId = null, $systemTypeId = null, $text = null)
    {
        $this
     ...
     * @return \ArrayType\ArrayOf_tns2_NetworkSignalV2|null
     */
     ...
     * @return \StructType\NetworkV2
     */
    public function setSignals_in(\ArrayType\ArrayOf_tns2_NetworkSignalV2 $signals_in = null)
    {
     ...
     * @return \StructType\NetworkV2
     */
    public function setSignals_out(\ArrayType\ArrayOf_tns2_NetworkSignalV2 $signals_out = null)
    {
