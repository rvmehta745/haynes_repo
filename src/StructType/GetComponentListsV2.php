...
/**
 * This class stands for getComponentListsV2 StructType
 * @subpackage Structs
 */
class GetComponentListsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getComponentListsV2
     * @uses GetComponentListsV2::setVrid()
     * @uses GetComponentListsV2::setSystem_types_ids()
     * @uses GetComponentListsV2::setLanguage()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetComponentListsV2
     */
    ...
    public static function validateSystem_types_idsForArrayConstraintsFromSetSystem_types_ids(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getComponentListsV2System_types_idsItem) {
            // validation for constraint: itemType
            if (!(is_int($getComponentListsV2System_types_idsItem) || ctype_digit($getComponentListsV2System_types_idsItem))) {
                $invalidValues[] = is_object($getComponentListsV2System_types_idsItem) ? get_class($getComponentListsV2System_types_idsItem) : sprintf('%s(%s)', gettype($getComponentListsV2System_types_idsItem), var_export($getComponentListsV2System_types_idsItem, true));
            }
        }
