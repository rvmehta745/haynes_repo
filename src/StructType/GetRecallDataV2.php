...
/**
 * This class stands for getRecallDataV2 StructType
 * @subpackage Structs
 */
class GetRecallDataV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getRecallDataV2
     * @uses GetRecallDataV2::setVrid()
     * @uses GetRecallDataV2::setDescriptionLanguage()
     * @uses GetRecallDataV2::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetRecallDataV2
     */
