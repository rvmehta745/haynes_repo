...
/**
 * This class stands for getAdjustmentsV2 StructType
 * @subpackage Structs
 */
class GetAdjustmentsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carType;
    /**
     * Constructor method for getAdjustmentsV2
     * @uses GetAdjustmentsV2::setVrid()
     * @uses GetAdjustmentsV2::setDescriptionLanguage()
     * @uses GetAdjustmentsV2::setCarType()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetAdjustmentsV2
     */
