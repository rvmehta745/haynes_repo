...
/**
 * This class stands for getWarningLightsV2 StructType
 * @subpackage Structs
 */
class GetWarningLightsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carType;
    /**
     * Constructor method for getWarningLightsV2
     * @uses GetWarningLightsV2::setVrid()
     * @uses GetWarningLightsV2::setDescriptionLanguage()
     * @uses GetWarningLightsV2::setCarType()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetWarningLightsV2
     */
