...
/**
 * This class stands for getMaintenanceSystems StructType
 * @subpackage Structs
 */
class GetMaintenanceSystems extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carType;
    /**
     * Constructor method for getMaintenanceSystems
     * @uses GetMaintenanceSystems::setVrid()
     * @uses GetMaintenanceSystems::setDescriptionLanguage()
     * @uses GetMaintenanceSystems::setCarType()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceSystems
     */
