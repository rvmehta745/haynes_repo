...
/**
 * This class stands for getStoryOverview StructType
 * @subpackage Structs
 */
class GetStoryOverview extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carType;
    /**
     * Constructor method for getStoryOverview
     * @uses GetStoryOverview::setVrid()
     * @uses GetStoryOverview::setDescriptionLanguage()
     * @uses GetStoryOverview::setCarType()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetStoryOverview
     */
