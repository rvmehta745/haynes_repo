...
/**
 * This class stands for getMaintenanceSystemsV3 StructType
 * @subpackage Structs
 */
class GetMaintenanceSystemsV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getMaintenanceSystemsV3
     * @uses GetMaintenanceSystemsV3::setVrid()
     * @uses GetMaintenanceSystemsV3::setDescriptionLanguage()
     * @uses GetMaintenanceSystemsV3::setCarTypeId()
     * @uses GetMaintenanceSystemsV3::setRepairtimesTypeId()
     * @uses GetMaintenanceSystemsV3::setUseImperial()
     * @uses GetMaintenanceSystemsV3::setIncludeServiceTimes()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceSystemsV3
     */
