...
/**
 * This class stands for getCompleteComponentV2 StructType
 * @subpackage Structs
 */
class GetCompleteComponentV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getCompleteComponentV2
     * @uses GetCompleteComponentV2::setVrid()
     * @uses GetCompleteComponentV2::setTypeId()
     * @uses GetCompleteComponentV2::setSi()
     * @uses GetCompleteComponentV2::setSt()
     * @uses GetCompleteComponentV2::setLanguage()
     * @param string $vrid
     * @param int $typeId
     * @param int $si
     * @param int $st
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetCompleteComponentV2
     */
