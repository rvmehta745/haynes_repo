...
/**
 * This class stands for getStoryInfoV3 StructType
 * @subpackage Structs
 */
class GetStoryInfoV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $smartLinks;
    /**
     * Constructor method for getStoryInfoV3
     * @uses GetStoryInfoV3::setVrid()
     * @uses GetStoryInfoV3::setDescriptionLanguage()
     * @uses GetStoryInfoV3::setCarTypeId()
     * @uses GetStoryInfoV3::setStoryId()
     * @uses GetStoryInfoV3::setSmartLinks()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetStoryInfoV3
     */
