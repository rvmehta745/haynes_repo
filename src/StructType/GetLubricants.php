...
/**
 * This class stands for getLubricants StructType
 * @subpackage Structs
 */
class GetLubricants extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carType;
    /**
     * Constructor method for getLubricants
     * @uses GetLubricants::setVrid()
     * @uses GetLubricants::setDescriptionLanguage()
     * @uses GetLubricants::setCarType()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetLubricants
     */
