...
/**
 * This class stands for ExtMaintenancePeriodV4 StructType
 * @subpackage Structs
 */
class ExtMaintenancePeriodV4 extends AbstractStructBase
{
    /**
     * The combinable
     * @var bool
    ...
    public $times;
    /**
     * Constructor method for ExtMaintenancePeriodV4
     * @uses ExtMaintenancePeriodV4::setCombinable()
     * @uses ExtMaintenancePeriodV4::setId()
     * @uses ExtMaintenancePeriodV4::setName()
     * @uses ExtMaintenancePeriodV4::setTimes()
     ...
     * @param bool $combinable
     * @return \StructType\ExtMaintenancePeriodV4
     */
