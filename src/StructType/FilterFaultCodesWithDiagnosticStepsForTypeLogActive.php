...
/**
 * This class stands for filterFaultCodesWithDiagnosticStepsForTypeLogActive
 * StructType
 * @subpackage Structs
 */
class FilterFaultCodesWithDiagnosticStepsForTypeLogActive extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for filterFaultCodesWithDiagnosticStepsForTypeLogActive
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActive::setVrid()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActive::setTypeId()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActive::setSystemTypeIds()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActive::setCodesin()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeLogActive::setLanguage()
     * @param string $vrid
     * @param int $typeId
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\FilterFaultCodesWithDiagnosticStepsForTypeLogActive
     */
    ...
    public static function validateCodesinForArrayConstraintsFromSetCodesin(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $filterFaultCodesWithDiagnosticStepsForTypeLogActiveCodesinItem) {
            // validation for constraint: itemType
            if (!is_string($filterFaultCodesWithDiagnosticStepsForTypeLogActiveCodesinItem)) {
                $invalidValues[] = is_object($filterFaultCodesWithDiagnosticStepsForTypeLogActiveCodesinItem) ? get_class($filterFaultCodesWithDiagnosticStepsForTypeLogActiveCodesinItem) : sprintf('%s(%s)', gettype($filterFaultCodesWithDiagnosticStepsForTypeLogActiveCodesinItem), var_export($filterFaultCodesWithDiagnosticStepsForTypeLogActiveCodesinItem, true));
            }
        }
