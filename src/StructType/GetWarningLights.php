...
/**
 * This class stands for getWarningLights StructType
 * @subpackage Structs
 */
class GetWarningLights extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carType;
    /**
     * Constructor method for getWarningLights
     * @uses GetWarningLights::setVrid()
     * @uses GetWarningLights::setDescriptionLanguage()
     * @uses GetWarningLights::setCarType()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetWarningLights
     */
