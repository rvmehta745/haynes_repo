...
/**
 * This class stands for ExtWearPartsIntervalV2 StructType
 * @subpackage Structs
 */
class ExtWearPartsIntervalV2 extends AbstractStructBase
{
    /**
     * The additionalTime
    ...
    public $status;
    /**
     * Constructor method for ExtWearPartsIntervalV2
     * @uses ExtWearPartsIntervalV2::setAdditionalTime()
     * @uses ExtWearPartsIntervalV2::setArticle()
     * @uses ExtWearPartsIntervalV2::setInterval()
     * @uses ExtWearPartsIntervalV2::setRepairNodes()
     * @uses ExtWearPartsIntervalV2::setStatus()
     ...
     */
    public function __construct($additionalTime = null, \StructType\ExtGeneralArticle $article = null, $interval = null, \ArrayType\ArrayOfExtRepairtimeNodeV3 $repairNodes = null, \StructType\ExtStatus $status = null)
    {
        $this
     ...
     * @param int $additionalTime
     * @return \StructType\ExtWearPartsIntervalV2
     */
