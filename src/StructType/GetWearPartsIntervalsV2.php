...
/**
 * This class stands for getWearPartsIntervalsV2 StructType
 * @subpackage Structs
 */
class GetWearPartsIntervalsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $tecdocNumber;
    /**
     * Constructor method for getWearPartsIntervalsV2
     * @uses GetWearPartsIntervalsV2::setVrid()
     * @uses GetWearPartsIntervalsV2::setDescriptionLanguage()
     * @uses GetWearPartsIntervalsV2::setCarTypeId()
     * @uses GetWearPartsIntervalsV2::setSystemId()
     * @uses GetWearPartsIntervalsV2::setTecdocNumber()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetWearPartsIntervalsV2
     */
