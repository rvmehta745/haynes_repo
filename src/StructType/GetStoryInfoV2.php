...
/**
 * This class stands for getStoryInfoV2 StructType
 * @subpackage Structs
 */
class GetStoryInfoV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $smartLinks;
    /**
     * Constructor method for getStoryInfoV2
     * @uses GetStoryInfoV2::setVrid()
     * @uses GetStoryInfoV2::setDescriptionLanguage()
     * @uses GetStoryInfoV2::setCarTypeId()
     * @uses GetStoryInfoV2::setStoryId()
     * @uses GetStoryInfoV2::setSmartLinks()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetStoryInfoV2
     */
