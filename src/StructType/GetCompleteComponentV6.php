...
/**
 * This class stands for getCompleteComponentV6 StructType
 * @subpackage Structs
 */
class GetCompleteComponentV6 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getCompleteComponentV6
     * @uses GetCompleteComponentV6::setVrid()
     * @uses GetCompleteComponentV6::setTypeId()
     * @uses GetCompleteComponentV6::setSi()
     * @uses GetCompleteComponentV6::setSt()
     * @uses GetCompleteComponentV6::setLanguage()
     * @param string $vrid
     * @param int $typeId
     * @param int $si
     * @param int $st
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetCompleteComponentV6
     */
