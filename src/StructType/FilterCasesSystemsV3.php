...
/**
 * This class stands for filterCasesSystemsV3 StructType
 * @subpackage Structs
 */
class FilterCasesSystemsV3 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $searchedText;
    /**
     * Constructor method for filterCasesSystemsV3
     * @uses FilterCasesSystemsV3::setVrid()
     * @uses FilterCasesSystemsV3::setDescriptionLanguage()
     * @uses FilterCasesSystemsV3::setCarTypeId()
     * @uses FilterCasesSystemsV3::setCarTypeGroup()
     * @uses FilterCasesSystemsV3::setSearchedText()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\FilterCasesSystemsV3
     */
