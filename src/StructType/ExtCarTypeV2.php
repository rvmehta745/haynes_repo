...
/**
 * This class stands for ExtCarTypeV2 StructType
 * @subpackage Structs
 */
class ExtCarTypeV2 extends AbstractStructBase
{
    /**
     * The capacity
    ...
    /**
     * Constructor method for ExtCarTypeV2
     * @uses ExtCarTypeV2::setCapacity()
     * @uses ExtCarTypeV2::setEngineCode()
     * @uses ExtCarTypeV2::setFuelType()
     * @uses ExtCarTypeV2::setFullName()
     * @uses ExtCarTypeV2::setId()
     * @uses ExtCarTypeV2::setLevel()
     * @uses ExtCarTypeV2::setMadeFrom()
     * @uses ExtCarTypeV2::setMadeUntil()
     * @uses ExtCarTypeV2::setModelPictureMimeDataName()
     * @uses ExtCarTypeV2::setName()
     * @uses ExtCarTypeV2::setOrder()
     * @uses ExtCarTypeV2::setOutput()
     * @uses ExtCarTypeV2::setRemark()
     * @uses ExtCarTypeV2::setRepairTimeTypes()
     * @uses ExtCarTypeV2::setStatus()
     * @uses ExtCarTypeV2::setSubjects()
     * @uses ExtCarTypeV2::setSubjectsByGroup()
     * @uses ExtCarTypeV2::setSuperCarTypeId()
     * @param int $capacity
     ...
     */
    public function __construct($capacity = null, $engineCode = null, $fuelType = null, $fullName = null, $id = null, $level = null, $madeFrom = null, $madeUntil = null, $modelPictureMimeDataName = null, $name = null, $order = null, $output = null, $remark = null, \ArrayType\ArrayOfExtRepairtimeTypeV3 $repairTimeTypes = null, \StructType\ExtStatus $status = null, \ArrayType\ArrayOf_xsd_string $subjects = null, \StructType\ExtMap $subjectsByGroup = null, $superCarTypeId = null)
    {
        $this
     ...
     * Set capacity value
     * @param int $capacity
     * @return \StructType\ExtCarTypeV2
     */
