...
/**
 * This class stands for getWearPartsIntervals StructType
 * @subpackage Structs
 */
class GetWearPartsIntervals extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $systemId;
    /**
     * Constructor method for getWearPartsIntervals
     * @uses GetWearPartsIntervals::setVrid()
     * @uses GetWearPartsIntervals::setDescriptionLanguage()
     * @uses GetWearPartsIntervals::setCarTypeId()
     * @uses GetWearPartsIntervals::setSystemId()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetWearPartsIntervals
     */
