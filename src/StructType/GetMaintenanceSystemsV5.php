...
/**
 * This class stands for getMaintenanceSystemsV5 StructType
 * @subpackage Structs
 */
class GetMaintenanceSystemsV5 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getMaintenanceSystemsV5
     * @uses GetMaintenanceSystemsV5::setVrid()
     * @uses GetMaintenanceSystemsV5::setDescriptionLanguage()
     * @uses GetMaintenanceSystemsV5::setCarTypeId()
     * @uses GetMaintenanceSystemsV5::setRepairtimesTypeId()
     * @uses GetMaintenanceSystemsV5::setRtTypeCategory()
     * @uses GetMaintenanceSystemsV5::setUseImperial()
     * @uses GetMaintenanceSystemsV5::setIncludeServiceTimes()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceSystemsV5
     */
