...
/**
 * This class stands for getCompleteComponentV7 StructType
 * @subpackage Structs
 */
class GetCompleteComponentV7 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getCompleteComponentV7
     * @uses GetCompleteComponentV7::setVrid()
     * @uses GetCompleteComponentV7::setTypeId()
     * @uses GetCompleteComponentV7::setSi()
     * @uses GetCompleteComponentV7::setSt()
     * @uses GetCompleteComponentV7::setLanguage()
     * @param string $vrid
     * @param int $typeId
     * @param int $si
     * @param int $st
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetCompleteComponentV7
     */
