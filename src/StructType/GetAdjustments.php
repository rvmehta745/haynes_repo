...
/**
 * This class stands for getAdjustments StructType
 * @subpackage Structs
 */
class GetAdjustments extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $carType;
    /**
     * Constructor method for getAdjustments
     * @uses GetAdjustments::setVrid()
     * @uses GetAdjustments::setDescriptionLanguage()
     * @uses GetAdjustments::setCarType()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetAdjustments
     */
