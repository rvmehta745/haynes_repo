...
/**
 * This class stands for filterFaultCodesWithDiagnosticStepsForTypeV2 StructType
 * @subpackage Structs
 */
class FilterFaultCodesWithDiagnosticStepsForTypeV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for filterFaultCodesWithDiagnosticStepsForTypeV2
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeV2::setVrid()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeV2::setTypeId()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeV2::setCodesin()
     * @uses FilterFaultCodesWithDiagnosticStepsForTypeV2::setLanguage()
     * @param string $vrid
     * @param int $typeId
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\FilterFaultCodesWithDiagnosticStepsForTypeV2
     */
    ...
    public static function validateCodesinForArrayConstraintsFromSetCodesin(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $filterFaultCodesWithDiagnosticStepsForTypeV2CodesinItem) {
            // validation for constraint: itemType
            if (!is_string($filterFaultCodesWithDiagnosticStepsForTypeV2CodesinItem)) {
                $invalidValues[] = is_object($filterFaultCodesWithDiagnosticStepsForTypeV2CodesinItem) ? get_class($filterFaultCodesWithDiagnosticStepsForTypeV2CodesinItem) : sprintf('%s(%s)', gettype($filterFaultCodesWithDiagnosticStepsForTypeV2CodesinItem), var_export($filterFaultCodesWithDiagnosticStepsForTypeV2CodesinItem, true));
            }
        }
