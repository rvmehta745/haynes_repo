...
/**
 * This class stands for getSystems StructType
 * @subpackage Structs
 */
class GetSystems extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $language;
    /**
     * Constructor method for getSystems
     * @uses GetSystems::setVrid()
     * @uses GetSystems::setTypeId()
     * @uses GetSystems::setLanguage()
     * @param string $vrid
     * @param int $typeId
