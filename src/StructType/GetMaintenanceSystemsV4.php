...
/**
 * This class stands for getMaintenanceSystemsV4 StructType
 * @subpackage Structs
 */
class GetMaintenanceSystemsV4 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    /**
     * Constructor method for getMaintenanceSystemsV4
     * @uses GetMaintenanceSystemsV4::setVrid()
     * @uses GetMaintenanceSystemsV4::setDescriptionLanguage()
     * @uses GetMaintenanceSystemsV4::setCarTypeId()
     * @uses GetMaintenanceSystemsV4::setRepairtimesTypeId()
     * @uses GetMaintenanceSystemsV4::setRtTypeCategory()
     * @uses GetMaintenanceSystemsV4::setUseImperial()
     * @uses GetMaintenanceSystemsV4::setIncludeServiceTimes()
     * @param string $vrid
     ...
     */
    public function __construct($vrid = null, $descriptionLanguage = null, $carTypeId = null, $repairtimesTypeId = null, $rtTypeCategory = null, $useImperial = null, $includeServiceTimes = null)
    {
        $this
            ->setVrid($vrid)
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\GetMaintenanceSystemsV4
     */
