...
/**
 * This class stands for filterTSBSystemsV2 StructType
 * @subpackage Structs
 */
class FilterTSBSystemsV2 extends AbstractStructBase
{
    /**
     * The vrid
     * @var string
    ...
    public $searchedText;
    /**
     * Constructor method for filterTSBSystemsV2
     * @uses FilterTSBSystemsV2::setVrid()
     * @uses FilterTSBSystemsV2::setDescriptionLanguage()
     * @uses FilterTSBSystemsV2::setCarTypeId()
     * @uses FilterTSBSystemsV2::setCarTypeGroup()
     * @uses FilterTSBSystemsV2::setSearchedText()
     * @param string $vrid
     ...
     * Set vrid value
     * @param string $vrid
     * @return \StructType\FilterTSBSystemsV2
     */
